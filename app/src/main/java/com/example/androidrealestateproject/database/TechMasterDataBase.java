...
@Database(entities = {User.class, UserServiceProvider.class, Review.class, Meet.class ,Post.class, Plan.class, Rental.class, Property.class},version = 6, exportSchema = false)
